<template>
  <body>
    <div
    class="group select-none w-120 flex flex-col p-4 relative items-center justify-center bg-gray-800 border border-gray-800 shadow-lg rounded-xl"
  >
    <div class="">
      <div class="text-center p-3 flex-auto justify-center">
        <svg
          fill="currentColor"
          viewBox="0 0 20 20"
          class="w-18 h-18 flex items-center text-gray-600 fill-red-500 mx-auto"
        ...
        <h2 class="text-4xl font-bold py-4 my-4 text-gray-200">Are you sure?</h2>
        <p class="font-bold text-lg text-gray-500 px-2">
